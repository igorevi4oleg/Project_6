...
class TestOrderPage:
    ...
    def test_order_flow(self, base_page, main_page, order_page, name, surname, address, phone, metro_station):
        ...
        base_page.get_current_url()

        assert base_page.get_current_url().startswith("https://qa-scooter.praktikum-services.ru/track?t=")
